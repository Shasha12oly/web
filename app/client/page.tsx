...
export default function ClientLogin() {
  ...
  const handleGoogleLogin = async () => {
    ...
    setLoading(true)
    try {
      // For demo, use a test Google account
  ...
  const handleDiscordLogin = async () => {
    ...
    setLoading(true)
    try {
      // For demo, use a test Discord account
  ...
  const handleGithubLogin = async () => {
    ...
    setLoading(true)
    try {
      // For demo, use a test GitHub account
        ...
        <div className="bg-gray-800/50 backdrop-blur border border-gray-700 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4 mb-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition"
                required
              />
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400 text-sm">
              ...
              <Link href="/client/signup" className="text-cyan-400 hover:text-cyan-300 font-medium transition">
                Sign up
              </Link>
            </p>
          </div>
